...
#define SHT1x_SCK_LO	gpio_set(RPI_GPIO_SHT1x_SCK, 0)
#define SHT1x_SCK_HI	gpio_set(RPI_GPIO_SHT1x_SCK, 1)

#define SHT1x_DATA_LO	{ gpio_dir(RPI_GPIO_SHT1x_DATA, GPIO_MODE_OUT); \
		gpio_set(RPI_GPIO_SHT1x_DATA, 0); }
#define SHT1x_DATA_HI	gpio_dir(RPI_GPIO_SHT1x_DATA, GPIO_MODE_IN);
#define SHT1x_GET_BIT	gpio_get(RPI_GPIO_SHT1x_DATA)
